...
export function normalizeMatchState(state: MatchState): MatchState {
  return {
    ...
    homeTactics: state.homeTactics ?? null,
    awayTactics: state.awayTactics ?? null,
    ...
    homeActiveInjuries: state.homeActiveInjuries ?? {},
    awayActiveInjuries: state.awayActiveInjuries ?? {},
    persistentMatchMode: state.persistentMatchMode ?? false,
