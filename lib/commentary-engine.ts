...
const STRAIGHT: Record<CommentaryKind, string[]> = {
  ...
  freekick: [
    ...
    "{taker} places the ball — this is in shooting range for {team}.",
  ],
  freekick_cross: [
    "{taker} floats the free kick into the box for {team}!",
    "Free kick whipped in by {taker} — {target} attacks it!",
    "{taker} delivers from the set piece — {target} is up for {team}!",
    "In-swinging free kick from {taker}! {target} rises for {team}!",
    "{taker} curls it into the mixer — {target} waiting for {team}!",
  ],
  freekick_goal: [
    "GOAL! {scorer} scores direct from the free kick!",
    "GOAL! What a free kick! {scorer} bends it in!",
    "GOAL! Unstoppable from {scorer} — straight from the set piece!",
    "GOAL! {scorer} whips it over the wall and in!",
    "GOAL! Top corner! {scorer} with a sensational free kick!",
    "GOAL! The free kick specialist {scorer} does it again!",
  ],
  freekick_header_goal: [
    "GOAL! {scorer} heads in from {taker}'s free kick!",
    "GOAL! {taker} puts it on a plate — {scorer} heads home!",
    "GOAL! Perfect delivery from {taker}, {scorer} nods it in!",
    "GOAL! {scorer} powers a header from {taker}'s cross!",
    "GOAL! {scorer} meets {taker}'s free kick — in off the bar!",
  ],
  freekick_save: [
    "{gk} keeps out {shooter}'s free kick!",
    "Brilliant save! {gk} denies {shooter} from the set piece!",
    "{gk} tips {shooter}'s free kick round the post!",
    "{shooter}'s free kick — {gk} says no!",
    "Fine stop from {gk} to thwart {shooter}'s effort!",
  ],
  freekick_miss: [
    "{shooter}'s free kick flies over the bar!",
    "{shooter} curls it wide from the free kick!",
    "The free kick from {shooter} drifts past the post!",
    "{shooter} can't get the free kick on target!",
    "Over from {shooter} — wasted free kick!",
  ],
  turnover: [
